 ...
 function open_tip(arr) {
        ...
        , cols: [[
                ...
                field: 'cover_photo', width: 180, title: '封面图片', sort: true
                        ...
                        return "<div><img src=" + fullUrl(BaseUrl,d.cover_photo) + "></div>"
                                ...
                                , {
                field: 'course_type', width: 180, title: '课程类型', sort: true
                                                                                
            }
                                , {
                field: 'class_location', width: 180, title: '上课地点', sort: true
                ...
                field: 'class_time', width: 180, title: '上课时间', sort: true
                                ...
                                , {
                field: 'number_of_courses', width: 180, title: '课程人数', sort: true
                                                                                
            }
                                , {
                field: 'number_of_people_available', width: 180, title: '可选人数', sort: true
            ...
            if (res.count == null) { // 无数据时直接返回了
                return;
                        ...
                        $("[data-field='course_type']").css('display', 'none');
                                        ...
                                        if (user_group === '管理员' || $check_field('get', 'class_location', path1)) {
                        // console.log("显示")
                    } else {
                        $("[data-field='class_location']").css('display', 'none');
                    }
                        ...
                        $("[data-field='class_time']").css('display', 'none');
                                        ...
                                        if (user_group === '管理员' || $check_field('get', 'number_of_courses', path1)) {
                        // console.log("显示")
                    } else {
                        $("[data-field='number_of_courses']").css('display', 'none');
                    }
                                        if (user_group === '管理员' || $check_field('get', 'number_of_people_available', path1)) {
                        // console.log("显示")
                    } else {
                        $("[data-field='number_of_people_available']").css('display', 'none');
                    }
    ...
    ,
        ...
        if (obj.event === 'detail')
        {
                            ...
                            window.location.href = "./view_add.jsp?" + data.course_information_id;
                    }
                ...
                window.location.href = "../comment/view_comments.jsp?" + data.course_information_id;
            }
