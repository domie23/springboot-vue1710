        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li>
                ...
                <li class="layui-nav-item layui-hide layui-show-md-inline-block"
                    ...
                    <a href="http://localhost:8081/">网站首页</a>
            </ul>
            </div>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dl class="layui-nav-child">
                                                            <dd><a href="./slides/table.jsp" target="main_self_frame">轮播图</a></dd>
                                                                                        <dd><a href="./notice/table.jsp" target="main_self_frame">公告信息</a></dd>
                                                                                </dl>
                    </li>
                ...
                <li class="layui-nav-item" id="userManagement" style="display: none;">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="./user/table.jsp" target="main_self_frame" id="user">管理员</a></dd>
                                    ...
                                    <a href="./student_users/table.jsp" target="main_self_frame">学生用户</a>
                                </dd>
                                                                                                                <dd style="display: none" id="teacher_user">
                                    <a href="./teacher_user/table.jsp" target="main_self_frame">老师用户</a>
                                </dd>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </dl>
                </li>
...
<script>
    ...
    console.log(personInfo)
        ...
        if(user_group == '管理员' || $check_group(['/user/table','/user_group/table','/auth/table'                            ,'/student_users/table'
                                                ,'/teacher_user/table'
                                                                                                                                                                                                                ])){
            userManagement.style.display = 'block'
        }
            ...
            user.style.display = "none"
                ...
                if(user_group == '管理员' || $check_action('/student_users/table')){
                        ...
                        student_users.style.display = "none"
                                                ...
                                                let teacher_user = document.querySelector('#teacher_user')
                if(user_group == '管理员' || $check_action('/teacher_user/table')){
                        teacher_user.style.display = "block"
                }else {
                        teacher_user.style.display = "none"
                }
